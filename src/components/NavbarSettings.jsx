...
import AccountCircleIcon from "../media/icons/account_circle.svg"; 
import NotificationsIcon from "../media/icons/notifications-icon.svg"; 
import PrivacyIcon from "../media/icons/privacy-icon.svg"; 
import HelpIcon from "../media/icons/help-icon.svg"; 
import SupportIcon from "../media/icons/support_icon.svg"; 
import LanguagesIcon from "../media/icons/languages-icon.svg"; 
