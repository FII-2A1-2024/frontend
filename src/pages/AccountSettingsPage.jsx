    ...
    return (
      <>
            ...
            <div className="landing-page">
              {isTabletSize ? <Navbar_superior toggleNavbar={toggleNavbar} /> : <Navbar_superior /> }
                        ...
                        <div className="setting-preferences">
                          ...
                          <div className="settings-item-function-container">
                            ...
                            <div className="setting-option-line">
                                ...
                                <button className="button-change-language" onClick={handleResetPassword}>{t("Change")}</button>
                            </div>
                            <div className="reset-password-container" style={{display: showResetPass ? "flex" : "none" }}>
                              ...
                              <div className="setting-option-line">
                                <div className="reset-password-line-link">{t("Can't remember your password?")} <Link className="link-to-reset-page">{t("Reset password")}</Link></div>
                              </div>

                              <div className="setting-option-line">
                                <button className="button-change-password">{t("Save password")}</button>
                              </div>
                            </div>
