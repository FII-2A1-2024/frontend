...
Pe partea de backend la resetPasswordController.js trebuie schimbata linia asta

const resetLink = `http://${process.env.SERVER_IP}:${process.env.SERVER_PORT}/resetPass/verify?token=${resetToken}`;

in asta:

const resetLink = `http://${process.env.SERVER_IP}:5173/verify?token=${resetToken}`;
